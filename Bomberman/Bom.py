...
class Bom:
    ...
    def calcBurstArea(Bom, Object, Board, Human: list):
        for i in Bom:
            # print(i.right)ß
            # print(i.left)
            # print(i.up)
            # print(i.down)
            bom_time(i)
            bom_var(i, Object, Board.height)
            bom_side(i, Object, Board.width)
        while (True):
            count = 0
            for i in Bom:
                if i.flag == 1:
